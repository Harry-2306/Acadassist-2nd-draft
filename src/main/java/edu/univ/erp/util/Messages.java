...
public class Messages {
    ...
    public static final String DUPLICATE_VALUE="Redundant value being entered";
    ...
    public static final String DEADLINE_EXPIRED="Deadline for dropping courses expired";
